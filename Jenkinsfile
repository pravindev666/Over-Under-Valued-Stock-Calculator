    ...
    stages {
        ...
        stage('GIT CHECKOUT') {
            steps {
                ...
                git branch: 'main', url: 'https://github.com/pravindev666/Over-Under-Valued-Stock-Calculator.git'
            }
        }
            ...
            steps {
                ...
                withSonarQubeEnv('sonar') {
                    sh """
                        ...
                        -Dsonar.projectKey=valuation-calculator \
                        -Dsonar.projectName="Valuation Calculator by Pravin A Mathew" \
            ...
            steps {
                script {
                    ...
                    withDockerRegistry(credentialsId: 'docker-cred', toolName: 'docker') {
                        sh 'docker build -t valuation-calculator .'
                    }
                }
            }
        }
        ...
        stage('IMAGE SCANNING') {
            steps {
                ...
                sh 'trivy image --format table -o trivy-image-report.html valuation-calculator'
            }
        }
        ...
        stage('DOCKER DEPLOYMENT') {
            steps {
                ...
                sh 'docker run -d -p 8090:80 valuation-calculator'
            }
        }
    }
}
